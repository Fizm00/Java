package Semester_2_Practice.FirzaArrayListPP01;
import java.util.*;
...
class ShoppingCart { 
    ...
    public double getTotalPrice() {
        ...
        for (int i = 0; i < itemOrders.size(); i++) {
            ...
            if (itemOrder.getDiscountStatus() == false && itemOrder.getQuantity() >= 3) {
                itemOrder.applyDiscount();
                double discount = calculateDiscount(itemOrder);
                price -= discount;
            }
            totalPrice += price;
        }
